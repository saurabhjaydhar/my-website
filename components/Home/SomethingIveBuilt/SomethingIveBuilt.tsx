        ...
        >
          ...
          >
           ...
           transition-opacity opacity-20 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <a href="https://drisk.ai/" target={"_blank"} rel="noreferrer">
                <div
                  // onClick={}
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">Drisk </span>
                <a
                ...
                >
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    Finally, a platform to handle all the requirements of
                    training, test and validation, so you can get back to
                    building the best Autonomous Driving System.
                  </span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  ...
                  dRISK is a full-stack solution for training, test and
                  validation on Level 2-5 ADAS/AV/ADS software, preparing
                  autonomy to handle regulatory requirements, and the full
                  complexity of the real world, for the next generation of
                  highly effective and commercially viable autonomous solutions.
                </p>
              </div>
              {/* <ul
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                ...
                >
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    Big Ideas in 5 mins:Bite sized
                  </span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  Discover the power of learning with   <span className="text-AAsecondary"> Big Ideas</span> , the ultimate
                  app for extracting bite-sized wisdom from a world of
                  knowledge. Dive into an expansive universe of topics, from
                  cutting-edge AI insights to profound mental health strategies.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
